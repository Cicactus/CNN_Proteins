...
parser.add_argument("--model_path", type=str, default='./Q8_BEST_MODEL_7_5_3_2_1_512_68.48_FOR_CPU')
...
# Robust Model Architecture Parsing
...
# Fallback for activation arguments (good to keep)
if not hasattr(args, 'conv_activation'):
    args.conv_activation = 'tanh'
if not hasattr(args, 'fc_activation'):
    args.fc_activation = 'leakyrelu'
...
class Model(nn.Module):
    def __init__(self, freeze_conv=False):
        ...
        # but 380 is a common fixed input length for Q8.
        l = 380
...
if y_true_rmsd_data_combined is not None: # Check if true labels were available for the dataset
    ...
    y_true_indices = np.argmax(y_true_rmsd_data_combined, axis=1)

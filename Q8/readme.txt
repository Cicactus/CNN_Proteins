CNN_Q8.py - program to train CNN for protein secondary structure prediction by DSSP 8 without reliancy to the evolutionary information (i.e. sequence alignments).
training_script_CNN.sh - script for launching learning and iterating over hyperparameters.
prediction_Q8.py - program for calculating accuracies across datasets.
confusion_Q8.py - program for calculating confusion matrix and classification report.
...
Q8_BEST_MODEL_7_5_3_2_1_512_tanh_leakyrelu_68.48_FOR_CPU
Q8_BEST_MODEL_7_5_3_2_1_512_tanh_leakyrelu_68.48
...
4. Make the script execitable, modify the parameters lists, and run the script
